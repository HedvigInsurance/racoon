...
export type AdditionalPaymentsDetailsResponse = AdditionalPaymentsDetailsResponseAction | AdditionalPaymentsDetailsResponseFinished;
...
export type Agreement = DanishAccidentAgreement | DanishHomeContentAgreement | DanishTravelAgreement | NorwegianHomeContentAgreement | NorwegianTravelAgreement | SwedishAccidentAgreement | SwedishApartmentAgreement | SwedishHouseAgreement;
...
export type ConnectPaymentResult = ActionRequired | ConnectPaymentFinished;
...
export type ContractStatus = ActiveInFutureAndTerminatedInFutureStatus | ActiveInFutureStatus | ActiveStatus | PendingStatus | TerminatedInFutureStatus | TerminatedStatus | TerminatedTodayStatus;
...
export type EmbarkApiGraphQlVariable = EmbarkApiGraphQlGeneratedVariable | EmbarkApiGraphQlMultiActionVariable | EmbarkApiGraphQlSingleVariable;

export enum EmbarkApiGraphQlVariableGeneratedType {
  Uuid = 'uuid'
}

export type EmbarkAction = EmbarkAddressAutocompleteAction | EmbarkAudioRecorderAction | EmbarkDatePickerAction | EmbarkExternalInsuranceProviderAction | EmbarkMultiAction | EmbarkNumberAction | EmbarkNumberActionSet | EmbarkPreviousInsuranceProviderAction | EmbarkSelectAction | EmbarkTextAction | EmbarkTextActionSet;
...
export type EmbarkApi = EmbarkApiCreateQuote | EmbarkApiGraphQlMutation | EmbarkApiGraphQlQuery | EmbarkApiHouseInformation | EmbarkApiPersonalInformation;
...
export type EmbarkExpression = EmbarkExpressionBinary | EmbarkExpressionMultiple | EmbarkExpressionUnary;
...
export type EmbarkMultiActionComponent = EmbarkDropdownAction | EmbarkMultiActionNumberAction | EmbarkSwitchAction;
...
export type EmbarkRedirect = EmbarkRedirectBinaryExpression | EmbarkRedirectMultipleExpressions | EmbarkRedirectUnaryExpression;
...
export type EmbarkStoryMetadataEntry = EmbarkStoryMetaDataEntryWebUrlPath | EmbarkStoryMetadataEntryBackground | EmbarkStoryMetadataEntryDiscount | EmbarkStoryMetadataEntryPill;
...
export type ExchangeTokenResponse = ExchangeTokenExpiredResponse | ExchangeTokenInvalidResponse | ExchangeTokenSuccessResponse;
...
export type Incentive = FreeMonths | IndefinitePercentageDiscount | MonthlyCostDeduction | NoDiscount | PercentageDiscountMonths | VisibleNoDiscount;
...
export type MessageBody = MessageBodyAudio | MessageBodyBankIdCollect | MessageBodyFile | MessageBodyMultipleSelect | MessageBodyNumber | MessageBodyParagraph | MessageBodySingleSelect | MessageBodyText | MessageBodyUndefined;
...
export type MessageBodyChoices = MessageBodyChoicesLink | MessageBodyChoicesSelection | MessageBodyChoicesUndefined;
...
export type QuoteDetails = DanishAccidentDetails | DanishHomeContentsDetails | DanishTravelDetails | NorwegianHomeContentsDetails | NorwegianTravelDetails | SwedishAccidentDetails | SwedishApartmentQuoteDetails | SwedishHouseQuoteDetails;
...
export type RedeemedCodeV2Result = CampaignCannotBeCombinedWithExisting | CampaignDoesNotExist | CampaignHasExpired | CannotRedeemCampaignFromDifferentMarket | CannotRedeemEmptyCode | CannotRedeemOwnCampaign | MemberIsNotEligibleForCampaign | SuccessfulRedeemResult;
...
export type RemoveCampaignCodeResult = CannotRemoveActiveCampaignCode | SuccessfullyRemovedCampaignsResult;
...
export type ScheduledOperationAffectedDocument = AppMarketingImage | Asset | CoreMlModel | Faq | ImportantMessage | Key | KeyGearItemCoverage | Language | MarketingStory | Translation | UserFeature;
...
export type StartSignResponse = DanishBankIdSession | FailedToStartSign | NorwegianBankIdSession | SimpleSignSession | SwedishBankIdSession;
...
export type UpdateReferralCampaignCodeResult = CodeAlreadyTaken | CodeTooLong | CodeTooShort | ExceededMaximumUpdates | SuccessfullyUpdatedCode;
...
export type CampaignQuery = { __typename?: 'Query', campaign?: { __typename?: 'Campaign', code: string } | null | undefined };
