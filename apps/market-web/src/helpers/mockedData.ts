...
const footerText: MarkdownHtmlComponent = {
  _uid: '5',
  html: '<div><p>© Hedvig AB 2020</p></div><div><p>Hedvig HQ, Valhallavägen 117 K, SE–115 31, Stockholm, SWE Org. nr. 559093-0334</p></div>',
  original:
...
const safetyText: MarkdownHtmlComponent = {
  _uid: '5',
  html: '<p>Hedvig backas av HDI med över 200 års erfarenhet och 600 miljarder kr på kontot – du är i trygga händer. Hedvig står under Finansinspektionens tillsyn.</p>',
  original:
...
const cookie_consent_message: MarkdownHtmlComponent = {
  _uid: '5',
  html: 'Vi använder cookies, en liten datafil som lagras i din dator, för att hantera inloggningar, öka säkerheten för våra användare och förbättra de tjänster vi erbjuder. Om du inte vill att vi använder cookies kan du enkelt stänga av det i din browser. <a href="/legal">Läs mer</a>',
  original:
...
const exampleBannerText: MarkdownHtmlComponent = {
  _uid: '1234',
  html: '<p><strong>Corona-viruset – <a href="https://www.hedvig.com/blog/coronaviruset">så fungerar din försäkring</a></strong></p>',
  original:
