...
Default.args = {
  _uid: '1ec18e22-14o6-443f-b553-d64027697603',
  ...
  accordions: [
    ...
    },
    {
      ...
      paragraph: {
        ...
        html: '<p>Du kan fråga Hedvig vad som helst när som helst direkt i appen. Du kan självklart också be en av oss att ringa upp dig. Om du gillar att maila når du Hedvig på <a href="mailto:hedvig@hedvig.com">hedvig@hedvig.com</a></p>\n',
        plugin: 'markdown-html',
        original:
    ...
    },
    {
      ...
      paragraph: {
        ...
        html: '<p>Försäkringsbolag brukar vanligtvis ha en förmåga att gömma mycket i det finstilta. Vi är lite annorlunda. Därför har vi gjort allt vi kan för att skriva ett villkor på så enkel svenska som möjligt. Du hittar det här:</p>\n<p><a href="https://cdn.hedvig.com/info/forsakringsvillkor-bostadsratt-2018-02.pdf">– Villkor Hedvig Hemförsäkring Bostadsrätt</a></p>\n',
        plugin: 'markdown-html',
        original:
    ...
    },
    {
      ...
      paragraph: {
        ...
        html: '<p>Alla våra försäkringar är utan bindningstid. Vi tror på att nöjda kunder stannar för att de är nöjda, inte för att de är tvingas.</p>\n',
        plugin: 'markdown-html',
        original:
