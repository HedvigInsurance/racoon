...
gql`
  mutation AddSubclaimRecovery($subclaimId: ID!, $request: AddRecoveryInput!) {
    subclaim_addRecovery(subclaimId: $subclaimId, request: $request) {
      id
      recoveries {
        ...SubclaimRecovery
      }
...
export const SubclaimRecovery: React.FC<{
  subclaimId: string
}> = ({ subclaimId }) => {
