...
import { PaymentProvidersQuery, PaymentProvidersQueryVariables } from '@/services/apollo/generated'
...
export const mockPaymentHandlers = [
  api.query<PaymentProvidersQuery, PaymentProvidersQueryVariables>(
    PAYMENT_PROVIDERS,
    (_, res, ctx) => {
      return res(
        ctx.data({
