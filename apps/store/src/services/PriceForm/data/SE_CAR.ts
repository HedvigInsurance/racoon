      ...
      items: [
        ...
        },
        {
          field: {
            ...
            required: true,
            options: [
              { label: { key: '1 000 miles/year' }, value: '1000' },
              { label: { key: '1 500 miles/year' }, value: '1500' },
              { label: { key: '2 000 miles/year' }, value: '2000' },
              { label: { key: '2 500 miles/year' }, value: '2500' },
              { label: { key: '2 500+ miles/year' }, value: '2501' },
            ],
          },
          layout: { columnSpan: 6 },
        },
