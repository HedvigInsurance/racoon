...
import { ListItem, StyledCheckList } from './CheckList'
          ...
          <Space y={4}>
            ...
            <section>
              <Space y={1}>
                ...
                <Space y={0.5}>
                  <StyledCheckList>
                    <ListItem.Checked title="Teckna Hedvig" />
                    <ListItem.Checked title="Koppla autogiro" />
                    <ListItem.Unchecked title="Ladda ner Hedvig appen">
                      {platform ? (
