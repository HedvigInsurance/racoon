...
/******/ var __webpack_modules__ = {
    ...
    __webpack_require__.a(
      ...
      async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          ;[pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__, web_l10n_utils__WEBPACK_IMPORTED_MODULE_1__] =
            __webpack_async_dependencies__.then
              ? (await __webpack_async_dependencies__)()
              : __webpack_async_dependencies__
            ...
            #bindListeners({
              ...
              this.eventBus._on('annotationeditorparamschanged', (evt) => {
                for (const [type, value] of evt.details) {
                  switch (type) {
                    case pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.AnnotationEditorParamsType
                      .FREETEXT_SIZE:
            ...
            async render(viewport, intent = 'display') {
              ...
              if (this.linkService.isInPresentationMode) {
                this.#updatePresentationModeState(
                  _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.PresentationModeState.FULLSCREEN,
                )
              }
        ...
        try {
          ...
          const PDFViewerApplication = {
            ...
            async initialize(appConfig) {
              ...
              let mode
              switch (
                _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('viewerCssTheme')
              ) {
                case 1:
                  mode = 'is-light'
                  break
            ...
            async _initializeViewerComponents() {
              ...
              const eventBus = _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get(
                'isInAutomation',
              )
              ...
              const pdfLinkService =
                new _pdf_link_service_js__WEBPACK_IMPORTED_MODULE_4__.PDFLinkService({
                  ...
                  externalLinkRel:
                    _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('externalLinkRel'),
              ...
              const annotationEditorMode =
                _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('annotationEditorMode')
              ...
              const pdfViewer = new _pdf_viewer_js__WEBPACK_IMPORTED_MODULE_21__.PDFViewer({
                ...
                findController,
                scriptingManager:
                  _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('enableScripting') &&
                  pdfScriptingManager,
                l10n,
                textLayerMode:
                  _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('textLayerMode'),
                annotationMode:
                  _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('annotationMode'),
                ...
                imageResourcesPath:
                  _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('imageResourcesPath'),
                ...
                isOffscreenCanvasSupported,
                maxCanvasPixels:
                  _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('maxCanvasPixels'),
                enablePermissions:
                  _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('enablePermissions'),
                pageColors,
              })
              ...
              if (
                !this.isViewerEmbedded &&
                !_app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('disableHistory')
              ) {
              ...
              if (!this.supportsIntegratedFind && appConfig.findBar) {
                this.findBar = new web_pdf_find_bar__WEBPACK_IMPORTED_MODULE_11__.PDFFindBar(
                  appConfig.findBar,
                  eventBus,
                )
              }
              if (appConfig.annotationEditorParams) {
                if (
                  annotationEditorMode !==
                  pdfjs_lib__WEBPACK_IMPORTED_MODULE_1__.AnnotationEditorType.DISABLE
                ) {
              ...
              if (appConfig.toolbar) {
                this.toolbar = new web_toolbar__WEBPACK_IMPORTED_MODULE_23__.Toolbar(
                  appConfig.toolbar,
                  eventBus,
                )
              }
            ...
            async run(config) {
              ...
              const params = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.parseQueryString)(
                queryString,
              )
              file =
                params.get('file') ??
                _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('defaultUrl')
            ...
            zoomIn(steps, scaleFactor) {
              ...
              this.pdfViewer.increaseScale({
                drawingDelay:
                  _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('defaultZoomDelay'),
                steps,
                scaleFactor,
              })
            },
            ...
            get loadingBar() {
              ...
              const bar = barElement
                ? new _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.ProgressBar(barElement)
                : null
            ...
            setTitleUsingUrl(url = '', downloadUrl = null) {
              ...
              if (!title) {
                try {
                  title =
                    decodeURIComponent(
                      (0, pdfjs_lib__WEBPACK_IMPORTED_MODULE_1__.getFilenameFromUrl)(url),
                    ) || url
                } catch {
                  title = url
                }
            ...
            get _docFilename() {
              return (
                ...
                (0, pdfjs_lib__WEBPACK_IMPORTED_MODULE_1__.getPdfFilenameFromUrl)(this.url)
              )
            },
            _hideViewBookmark() {
            ...
            async open(args) {
              ...
              return loadingTask.promise.then(
                ...
                (reason) => {
                  ...
                  if (
                    reason instanceof pdfjs_lib__WEBPACK_IMPORTED_MODULE_1__.InvalidPDFException
                  ) {
                    key = 'pdfjs-invalid-file-error'
                  } else if (
                    reason instanceof pdfjs_lib__WEBPACK_IMPORTED_MODULE_1__.MissingPDFException
                  ) {
              ...
              firstPagePromise.then((pdfPage) => {
                ...
                Promise.all([
                  ...
                  .then(async ([timeStamp, stored, pageLayout, pageMode, openAction]) => {
                    const viewOnLoad =
                      _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('viewOnLoad')
                    ...
                    if (stored?.page && viewOnLoad !== ViewOnLoad.INITIAL) {
                      ...
                      if (
                        sidebarView ===
                        _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.SidebarView.UNKNOWN
                      ) {
                    ...
                    if (
                      ...
                      sidebarView = (0,
                      _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.apiPageModeToSidebarView)(pageMode)
                    }
                    if (
                      pageLayout &&
                      scrollMode === _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.ScrollMode.UNKNOWN &&
              ...
              if (jsActions) {
                ...
                for (const name in jsActions) {
                  ...
                  triggerAutoPrint = jsActions[name].some((js) =>
                    _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.AutoPrintRegExp.test(js),
                  )
                }
              }
              if (triggerAutoPrint) {
            ...
            async _initializePageLabels(pdfDocument) {
              ...
              if (
                !labels ||
                _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('disablePageLabels')
              ) {
                return
              }
            ...
            _initializePdfHistory({ fingerprint, viewOnLoad, initialDest = null }) {
              ...
              this.pdfHistory.initialize({
                ...
                updateUrl:
                  _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('historyUpdateUrl'),
              })
            ...
            _cleanup() {
              ...
              this.pdfDocument.cleanup(
                _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('fontExtraProperties'),
              )
            },
            forceRendering() {
            ...
            beforePrint() {
              ...
              const printResolution =
                _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('printResolution')
          ...
          async function loadFakeWorker() {
            ...
            await import(
              /* webpackIgnore: true */ pdfjs_lib__WEBPACK_IMPORTED_MODULE_1__.PDFWorker.workerSrc
            )
          }
          ...
          function webViewerWheel(evt) {
            ...
            if (
              ...
              if (isPinchToZoom && supportsPinchToZoom) {
                ...
                const delta = (0,
                _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.normalizeWheelEventDirection)(evt)
                let ticks = 0
                if (
  ...
  /***/ 9415: /***/ (
    ...
    class BaseTreeViewer {
      ...
      _normalizeTextContent(str) {
        return (
          (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.removeNullCharacters)(str, true) || '\u2013'
        )
      }
        ...
        try {
          ...
          class DownloadManager {
            ...
            downloadUrl(url, filename, _options) {
              if (
                !(0, pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.createValidAbsoluteUrl)(
                  url,
                  'http://example.com',
                )
              ) {
        ...
        try {
          ...
          class GenericL10n extends _l10n_js__WEBPACK_IMPORTED_MODULE_3__.L10n {
            ...
            static async #getPaths() {
              ...
              const paths = await (0, pdfjs_lib__WEBPACK_IMPORTED_MODULE_2__.fetchData)(
                href,
                'json',
              )
              return {
          ...
          class PasswordPrompt {
            ...
            async open() {
              ...
              const passwordIncorrect =
                this.#reason ===
                pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.PasswordResponses.INCORRECT_PASSWORD
            ...
            render({ attachments, keepRenderedCapability = false }) {
              ...
              for (const name in attachments) {
                ...
                const content = item.content,
                  filename = (0, pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.getFilenameFromUrl)(
                    item.filename,
                    true,
                  )
            ...
            #addEventListeners() {
              ...
              let annotationEditorMode =
                ...
                presentationModeState =
                  _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.PresentationModeState.NORMAL
              const disableActive = () => {
              ...
              this.eventBus._on('presentationmodechanged', ({ state }) => {
                ...
                if (
                  state === _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.PresentationModeState.NORMAL
                ) {
                  enableActive()
                } else if (
                  state ===
        ...
        try {
          ...
          class PDFDocumentProperties {
                ...
                await Promise.all([
                  ...
                  this.pdfDocument.getPage(currentPageNumber).then((pdfPage) => {
                    return this.#parsePageSize(
                      (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.getPageSizeInches)(pdfPage),
                      pagesRotation,
                    )
                  }),
            ...
            async #parsePageSize(pageSizeInches, pagesRotation) {
              ...
              const isPortrait = (0,
              _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.isPortraitOrientation)(pageSizeInches)
              let sizeInches = {
            ...
            async #parseDate(inputDate) {
              const dateObject =
                pdfjs_lib__WEBPACK_IMPORTED_MODULE_1__.PDFDateString.toDateObject(inputDate)
              if (!dateObject) {
                return undefined
              }
      ...
      async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          function getOriginalIndex(diffs, pos, len) {
            ...
            const start = pos
            const end = pos + len - 1
            let i = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.binarySearchFirstItem)(
              diffs,
              (x) => x[0] >= start,
            )
            if (diffs[i][0] > start) {
            ...
            let j = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.binarySearchFirstItem)(
              diffs,
              (x) => x[0] >= end,
              i,
            )
  ...
  /***/ 6418: /***/ (
    ...
    function isDestHashesEqual(destHash, pushHash) {
      ...
      const nameddest = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.parseQueryString)(
        destHash,
      ).get('nameddest')
        ...
        try {
          ...
          class PDFOutlineViewer extends _base_tree_viewer_js__WEBPACK_IMPORTED_MODULE_0__.BaseTreeViewer {
            ...
            async _currentOutlineItem() {
              ...
              if (
                this._sidebarView !== _ui_utils_js__WEBPACK_IMPORTED_MODULE_2__.SidebarView.OUTLINE
              ) {
                return
              }
      ...
      async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          const MAX_CANVAS_PIXELS =
            _app_options_js__WEBPACK_IMPORTED_MODULE_4__.compatibilityParams.maxCanvasPixels ||
            16777216
          ...
          class PDFPageView {
            ...
            async #finishRenderTask(renderTask, error = null) {
              ...
              if (
                error instanceof pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.RenderingCancelledException
              ) {
            ...
            async draw() {
              ...
              if (
                !this.textLayer &&
                this.#textLayerMode !==
                  _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.TextLayerMode.DISABLE &&
                !pdfPage.isPureXfa
              ) {
              ...
              const sfx = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.approximateFraction)(
                outputScale.sx,
              )
              const sfy = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.approximateFraction)(
                outputScale.sy,
              )
              canvas.width = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.roundToDivide)(
                width * outputScale.sx,
                sfx[0],
              )
              canvas.height = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.roundToDivide)(
                height * outputScale.sy,
                sfy[0],
              )
              const { style } = canvas
              style.width =
                (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.roundToDivide)(width, sfx[1]) + 'px'
              style.height =
                (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.roundToDivide)(height, sfy[1]) + 'px'
          ...
          class PDFPresentationMode {
            ...
            async request() {
              ...
              this.#notifyStateChange(
                _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.PresentationModeState.CHANGING,
              )
              ...
              try {
                ...
                this.#notifyStateChange(
                  _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.PresentationModeState.NORMAL,
                )
              }
              return false
            }
            get active() {
              return (
                this.#state ===
                  _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.PresentationModeState.CHANGING ||
                this.#state ===
                  _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.PresentationModeState.FULLSCREEN
              )
            }
            #mouseWheel(evt) {
              if (!this.active) {
              ...
              evt.preventDefault()
              const delta = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.normalizeWheelEventDelta)(
                evt,
              )
      ...
      async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          function renderPage(
            ...
            const PRINT_UNITS =
              printResolution / pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.PixelsPerInch.PDF
            ...
            return Promise.all([
              ...
              const renderContext = {
                ...
                intent: 'print',
                annotationMode:
                  pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.AnnotationMode.ENABLE_STORAGE,
                optionalContentConfigPromise,
          ...
          class PDFPrintService {
            ...
            renderPages() {
              if (this.pdfDocument.isPureXfa) {
                ;(0, _print_utils_js__WEBPACK_IMPORTED_MODULE_2__.getXfaHtmlForPrinting)(
                  this.printContainer,
                  this.pdfDocument,
                )
          ...
          function ensureOverlay() {
            if (!overlayPromise) {
              overlayManager =
                _app_js__WEBPACK_IMPORTED_MODULE_1__.PDFViewerApplication.overlayManager
              if (!overlayManager) {
                ...
                switch (command) {
                  ...
                  case 'layout':
                    if (!isInPresentationMode) {
                      const modes = (0,
                      _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.apiPageLayoutToViewerModes)(value)
        ...
        try {
          ...
          class PDFThumbnailView {
            ...
            async #finishRenderTask(renderTask, canvas, error = null) {
              ...
              if (
                error instanceof pdfjs_lib__WEBPACK_IMPORTED_MODULE_1__.RenderingCancelledException
              ) {
                return
              }
              this.renderingState =
        ...
        try {
          ...
          class PDFThumbnailViewer {
            constructor({ container, eventBus, linkService, renderingQueue, pageColors }) {
              ...
              this.renderingQueue = renderingQueue
              this.pageColors = pageColors || null
              this.scroll = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.watchScroll)(
                this.container,
      ...
      async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          function isValidAnnotationEditorMode(mode) {
            return (
              Object.values(pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.AnnotationEditorType).includes(
                mode,
          ...
          class PDFViewer {
            ...
            constructor(options) {
              ...
              this.scroll = (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.watchScroll)(
                this.container,
            ...
            #initializePermissions(permissions) {
              ...
              if (
                !permissions.includes(
                  pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.PermissionFlag.MODIFY_CONTENTS,
                )
              ) {
              ...
              if (
                !permissions.includes(
                  pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.PermissionFlag.MODIFY_ANNOTATIONS,
                ) &&
                !permissions.includes(
                  pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.PermissionFlag.FILL_INTERACTIVE_FORMS,
                ) &&
                this.#annotationMode ===
                  pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.AnnotationMode.ENABLE_FORMS
              ) {
                ...
                .then(([firstPdfPage, permissions]) => {
                  ...
                  if (
                    ...
                    if (pdfDocument.isPureXfa) {
                      ...
                      if (
                        mode !== pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.AnnotationEditorType.NONE
                      ) {
                  ...
                  const viewport = firstPdfPage.getViewport({
                    scale:
                      scale * pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.PixelsPerInch.PDF_TO_CSS_UNITS,
                  })
            ...
            #scrollIntoView(pageView, pageSpot = null) {
              ...
              if (!pageSpot && !this.isInPresentationMode) {
                ...
                if (
                  this._scrollMode ===
                    _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.ScrollMode.HORIZONTAL ||
                  left < scrollLeft ||
            ...
            #isSameScale(newScale) {
              return (
                newScale === this._currentScale || Math.abs(newScale - this._currentScale) < 1e-15
              )
            }
            #setScaleUpdatePages(
              newScale,
              ...
              if (scale > 0) {
                ...
                switch (value) {
                  ...
                  case 'auto':
                    ...
                    _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.isPortraitOrientation)(currentPage)
                      ? pageWidthScale
            ...
            get isChangingPresentationMode() {
              return (
                this.presentationModeState ===
                _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.PresentationModeState.CHANGING
              )
            }
            ...
            getPagesOverview() {
              ...
              return this._pages.map((pageView) => {
                ...
                const orientation = (0,
                _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.isPortraitOrientation)(viewport)
            ...
            _updateScrollMode(pageNumber = null) {
              ...
              viewer.classList.toggle(
                'scrollHorizontal',
                scrollMode === _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.ScrollMode.HORIZONTAL,
              )
              viewer.classList.toggle(
                'scrollWrapped',
                scrollMode === _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.ScrollMode.WRAPPED,
              )
            ...
            increaseScale({ drawingDelay, scaleFactor, steps } = {}) {
              ...
              if (scaleFactor > 1) {
                ...
                do {
                  newScale =
                    Math.ceil(
                      (
                        newScale * _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_SCALE_DELTA
                      ).toFixed(2) * 10,
                    ) / 10
                } while (
                  --steps > 0 &&
              ...
              this.#setScale(
                Math.min(_ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.MAX_SCALE, newScale),
                {
                  noScroll: false,
                  drawingDelay,
                },
            ...
            decreaseScale({ drawingDelay, scaleFactor, steps } = {}) {
              ...
              this.#setScale(
                Math.max(_ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.MIN_SCALE, newScale),
                {
                  noScroll: false,
                  drawingDelay,
                },
      ...
      async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          function getXfaHtmlForPrinting(printContainer, pdfDocument) {
            ...
            const scale =
              Math.round(
                pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.PixelsPerInch.PDF_TO_CSS_UNITS * 100,
              ) / 100
            for (const xfaPage of xfaHtml.children) {
              ...
              const viewport = (0, pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.getXfaPageViewport)(
                xfaPage,
                {
                  scale,
                },
      ...
      async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          class SecondaryToolbar {
            ...
            #updateUIState() {
              const { firstPageButton, lastPageButton, pageRotateCwButton, pageRotateCcwButton } =
                this.#opts
            ...
            #scrollModeChanged({ mode }) {
              ...
              const forceScrollModePage =
                this.pagesCount >
                _pdf_viewer_js__WEBPACK_IMPORTED_MODULE_1__.PagesCountLimit.FORCE_SCROLL_MODE_PAGE
      ...
      #setAttributes(structElement, htmlElement) {
        ...
        if (alt !== undefined) {
          htmlElement.setAttribute(
            'aria-label',
            (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.removeNullCharacters)(alt),
          )
        }
        if (id !== undefined) {
        ...
        if (lang !== undefined) {
          htmlElement.setAttribute(
            'lang',
            (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.removeNullCharacters)(lang, true),
          )
        }
      }
      #walk(node) {
              ...
              div.addEventListener('copy', (event) => {
                if (!this.#enablePermissions) {
                  ...
                  event.clipboardData.setData(
                    'text/plain',
                    (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.removeNullCharacters)(
                      (0, pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.normalizeUnicode)(
                        selection.toString(),
                      ),
                    ),
                  )
          ...
          class Toolbar {
            ...
            #updateUIState(resetNumPages = false) {
              ...
              opts.zoomOut.disabled =
                pageScale <= _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.MIN_SCALE
              opts.zoomIn.disabled =
                pageScale >= _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.MAX_SCALE
